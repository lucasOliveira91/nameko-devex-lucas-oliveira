...
def test_get_product(create_product, service_container, redis_client):
    ...
    assert redis_client.hgetall(f'products:{stored_product["id"]}')
...
def test_delete_product(create_product, service_container, redis_client):
    ...
    redis_product = redis_client.hgetall(f'products:{stored_product["id"]}')
    assert not redis_product
